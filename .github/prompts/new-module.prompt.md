...
crie as rotas no servidor (bff) que vai chamar o gateway para montar a mensagem de retorno.
Crie uma store em app/store que armazena os valores vindos do bff.
O papel de chamar o service, deve ficar dentro da store, lá ela gerencia os dados vindos do servidor
